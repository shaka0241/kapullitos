      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="opacity-90 mb-2 text-sm leading-relaxed">Si deseas apoyar nuestra causa o tienes alguna consulta, escríbenos a través del formulario de voluntarios.</p>
            <p className="opacity-70 text-xs mt-6">&copy; {new Date().getFullYear()} Fundación Kapullitos. Todos los derechos reservados.</p>
          </div>
        </div>
      </div>
    </footer>
